...
// In the above code, we are trying to access the variable b before it has been initialized. Since b is declared with const, it is in the TDZ until it is initialized with a value. Therefore, when we try to log b before its initialization, we get a ReferenceError.
